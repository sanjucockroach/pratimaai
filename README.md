...
- The homepage circuit film is supplied project media. The Services and About heroes use the exact supplied CloudFront media URLs; their local posters preserve the reduced-motion and data-saver fallback.
